...
import { date, label } from '../../../utils/formatters';

type AppointmentsTabProps = {
  appointmentsQuery: UseQueryResult<PublicList<PortalAppointment>, Error>;
  ...
  setRescheduleAppointment: (appointment: PortalAppointment) => void;
};
              ...
              <div className="portal-list-end">
                ...
                {['SCHEDULED', 'CONFIRMED', 'NO_SHOW', 'SKIPPED'].includes(item.status) ? (
                  <button
                    ...
                    onClick={() => setRescheduleAppointment(item)}
                    type="button"
                  >

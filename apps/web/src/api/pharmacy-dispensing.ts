...
export const pharmacyDispensingApi = {
  list: (params: { branch_id: string; search?: string; status?: DispensingQueueStatus; page?: number; limit?: number }) => apiClient.request<DispensingPage>(`/pharmacy/dispensings${queryString(params)}`),

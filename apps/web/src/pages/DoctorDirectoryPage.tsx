                ...
                <section className="doctor-onboarding-section">
                  ...
                  {form.createLoginAccount ? (
                    <div className="form-grid doctor-account-fields">
                      <div className="form-group"><label htmlFor="doctor-employee-code">Employee code *</label><input {...register('employeeCode')} autoComplete="off" disabled={submitting} id="doctor-employee-code" /></div>
                      <div className="form-group"><label htmlFor="doctor-username">Username *</label><input {...register('username')} autoComplete="off" disabled={submitting} id="doctor-username" /></div>
                      <div className="form-group"><label htmlFor="doctor-login-email">Login email *</label><input {...register('loginEmail')} autoComplete="off" disabled={submitting} id="doctor-login-email" type="email" /></div>
                      <div className="form-group"><label htmlFor="doctor-temporary-password">Temporary password *</label><input {...register('temporaryPassword')} autoComplete="new-password" disabled={submitting} id="doctor-temporary-password" type="password" /></div>
                      <div className="form-group"><label htmlFor="doctor-confirm-password">Confirm password *</label><input {...register('confirmTemporaryPassword')} autoComplete="new-password" disabled={submitting} id="doctor-confirm-password" type="password" /></div>

    ...
    return <div className="billing-page">
      ...
      <div className="billing-workspace-grid">
        ...
        <aside className="billing-summary-card">
          ...
          <button className="btn-primary billing-full-button" disabled={!canCreate || createMutation.isPending} onClick={createInvoice} type="button">{createMutation.isPending ? 'Creating...' : 'Create Invoice Draft'}</button>
        </aside>
      </div>
    </div>;
  }

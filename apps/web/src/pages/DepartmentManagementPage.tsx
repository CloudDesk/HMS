          ...
          <form id="dept-management-form" onSubmit={(e) => void handleSave(e)}>
            ...
            <div className="form-grid-3">
              <label className="form-field">
                ...
                <select
                  disabled={submitting}
                  aria-invalid={Boolean(deptForm.formState.errors.branch_id)}
                ...
                {deptForm.formState.errors.branch_id ? <small className="field-error">{deptForm.formState.errors.branch_id.message}</small> : null}
              </label>
              {modalMode === 'edit' && (
                <label className="form-field">
                  <span>Status</span>

...
export class AdmissionsConfigurationService {
  ...
  async summary(branchId: string, actor: string, metadata: StatusActionMetadata = {}) { void metadata; await this.authorize(actor, branchId); return this.repository.summary(branchId); }

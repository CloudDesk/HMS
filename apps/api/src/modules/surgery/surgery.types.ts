...
export type CreateProcedureRecommendationDTO = { patient_id: string; branch_id: string; department_id: string; recommending_doctor_id: string; service_id: string; encounter_type?: 'OPD_VISIT' | 'DIRECT' | 'EMERGENCY'; encounter_id?: string | null; clinical_reason: string; notes?: string | null };

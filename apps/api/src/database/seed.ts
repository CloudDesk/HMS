...
const administratorPermissionCodes = [
  ...
  ...['View', 'Create', 'Edit', 'ChangePassword', 'ResetPassword', 'Delete', 'Export'].map((action) => code('Administration', 'Users', action)),
  ...['View', 'Create', 'Edit', 'Assign', 'Delete'].map((action) => code('Administration', 'Roles', action)),
  ...['View', 'Assign'].map((action) => code('Administration', 'Permissions', action)),
  ...['Branches', 'Departments', 'Services', 'Medicines'].flatMap((screen) =>
    ['View', 'Create', 'Edit', 'Delete', 'Export'].map((action) => code('Administration', screen, action))),
  ...
  code('Patients', 'Patient Documents', 'View'),
  code('Patients', 'Consent', 'View'),
...
const roleDefinitions: RoleDefinition[] = [
  ...
  },
  {
    ...
    name: 'Receptionist',
    permissionCodes: [
      ...['Branches', 'Departments', 'Services'].map((screen) => code('Administration', screen, 'View')),
      ...
      ...['View', 'Create'].map((action) => code('OPD', 'OPD Visits', action)),
      code('OPD', 'OPD Referral', 'View'),
      ...
      ...['MarkNoShow', 'Cancel'].map((action) => code('Emergency', 'Disposition', action)),
  ...
  },
  {
    ...
    permissionCodes: [
      ...
      code('Emergency', 'Orders', 'View'),
      code('Emergency', 'Disposition', 'View'),
    ],
  },
  {
    code: 'DOCTOR',
    name: 'Doctor',
    permissionCodes: [
      ...['Branches', 'Departments', 'Services', 'Medicines'].map((screen) => code('Administration', screen, 'View')),
      ...
      ...['View', 'Complete'].map((action) => code('Surgery', 'Bookings', action)),
      code('Surgery', 'Schedule', 'View'),
      code('Emergency', 'Encounters', 'View'),
      code('Emergency', 'Triage', 'View'),
  ...
  },
  {
    ...
    name: 'Pharmacy User',
    permissionCodes: [
      code('Administration', 'Medicines', 'View'),
      code('Patients', 'Patient Records', 'View'),
  ...
  },
  {
    ...
    permissionCodes: [
      ...
      code('Patients', 'Patient Records', 'View'),
      ...['View', 'Edit', 'EnterResult', 'VerifyResult'].map((action) => code('Laboratory', 'Orders', action)),
    ],
  },
  {
    code: 'IMAGING_USER',
    ...
    permissionCodes: [
      code('Administration', 'Services', 'View'),
      code('Patients', 'Patient Records', 'View'),
      ...['View', 'Edit', 'EnterReport', 'VerifyReport'].map((action) => code('Imaging', 'Orders', action)),
    ],
  },
  {
    ...
    permissionCodes: [
      ...
      code('Surgery', 'Bookings', 'View'),
      code('Pharmacy', 'Dispensing', 'View'),
      code('Laboratory', 'Orders', 'View'),
      code('Imaging', 'Orders', 'View'),
